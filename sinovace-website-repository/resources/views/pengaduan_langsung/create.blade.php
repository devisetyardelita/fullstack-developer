...
<div class="content">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Formulir Tambah Layanan Pengaduan Langsung</h4>
        ...
        <div class="row">
            ...
            <div class="card mb-4">
                ...
                <h5 class="mb-0">Layanan Pengaduan Langsung</h5>
                </div>
                <div class="card-body">
                <form action="{{ route('pengaduan_langsung.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3 d-flex">
                        <label for="surat_permohonan_pengajuan" class="col-sm-2 col-form-label">Surat Permohonan Pengajuan</label>
                        <div class="col-sm-10">
                            <input type="file" id="surat_permohonan_pengajuan" name="surat_permohonan_pengajuan" class="form-control @error('surat_permohonan_pengajuan') is-invalid @enderror" />
                    ...
                    <div class="col-sm-10">
                        ...
                        <a href="{{ route('pengaduan_langsung') }}" class="btn btn-outline-secondary">Kembali</a>
                    </div>
                    </div>
                </form>
                </div>
