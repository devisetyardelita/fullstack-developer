      ...
      <h3 class="fw-bold mb-3" style="color: white">Data Layanan Izin Penelitian</h3>
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="navbar-nav align-items-left me-2" style="width: 75%;"> <!-- Atur lebar search -->
              <form action="{{ route('izin_penelitian') }}" method="GET">
          ...
          <!-- /Search and Filter Container -->
            ...
            <div class="divider d-flex justify-content-center align-items-center mt-0">
              ...
              <a href="{{ route('izin_penelitian.create') }}" class="btn rounded-pill btn-primary mx-1">
                      ...
                      <tbody id="tbody">                         
                        @foreach($izin_penelitian as $item)
                          <tr>
                            ...
                            <td>{{ $loop->iteration + $izin_penelitian->firstItem() - 1 }}</td>
...
<script>
  $(document).ready(function(){
    $('#applyFilter').on('click', function(){
      ...
      $.ajax({
        url: "{{ route('izin_penelitian.filter') }}", // Adjust the route to match your filter route
        type: "GET",
