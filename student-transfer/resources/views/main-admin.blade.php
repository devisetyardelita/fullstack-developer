        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ Request::is('admin/mutasi_siswa*') ? 'active' : '' }}">
              ...
              <!-- Izin Penelitian -->
              <li class="menu-item {{ Request::is('admin/mutasi_keluar*') ? 'active' : '' }}">
                <a href="{{ url('admin/mutasi_keluar') }}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-folder-minus"></i>
                  <div data-i18n="Analytics">Lapor Mutasi Keluar</div>
                </a>
              </li>

              <!-- Izin Penelitian -->
              <li class="menu-item {{ Request::is('admin/mutasi_masuk*') ? 'active' : '' }}">
                <a href="{{ url('admin/mutasi_masuk') }}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-folder-plus"></i>
                  <div data-i18n="Analytics">Lapor Mutasi Masuk</div>
                </a>
              </li>
