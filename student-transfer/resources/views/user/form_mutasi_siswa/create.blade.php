    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="text-white">
                <h2>Lapor Mutasi Siswa</h2>
                <p>
                    Layanan ini merupakan proses pelaporan adanya siswa yang bermutasi pada Dinas Pendidikan Kota Depok.
                    Proses pelaporan disini berupa perubahan data terbaru dari siswa pada DAPODIK.
                </p>
            </div>
            <div style="border: 1px solid #0174BE; background-color: #E0F0FF; padding: 20px; border-radius: 8px;">
                ...
                <ul style="font-size: 0.925rem">
                    <li>
                        Surat Rekomendasi Mutasi dari Sekolah Asal yang ditandatangani Kepala Sekolah dan Stempel Sekolah
                    </li>
                    <li>
                ...
                <ul style="font-size: 0.9rem">
                    ...
                    <li>
                        Pengajuan dapat diajukan kembali ketika 'status' pengajuan Anda <u>Selesai</u>.
                    </li>
                ...
                <ul style="list-style: none; padding: 0; margin: 0;">
                    <li style="display: flex; align-items: flex-start; font-size: .875rem; color: #dc3545; gap: .5em;">
                      ...
                      <span>
                        Perubahan data siswa pada DAPODIK akan diterbitkan setelah 2-3 hari kerja.
                      </span>
                    </li>
                </ul>
            </div>
            <div class="card shadow-lg border-0 mb-4 mt-2">
                <div class="card-header text-white" style="background-color: rgba(0, 154, 222, 0.95);">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <a href="{{ route('user.lapordetails', ['tipe' => $item->tipe == 'dalam' ? 'dalam' : 'luar', 'id' => $item->id]) }}" class="fw-bold text-dark text-decoration-none">
                                                    {{ $item->nama_siswa }}
                                                </a>
                                                <div class="mt-1">
        ...
        <div class="col-md-6">
            <div class="card p-4 bg-light custom-card mb-4">
                <h3 class="text-center"> Formulir Mutasi Siswa</h3>
                ...
                <ul class="nav nav-underline custom-tabs" id="mutasiTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="{{ route('user.mutasi_siswa.create', ['tipe' => 'dalam']) }}" 
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="{{ route('user.mutasi_siswa.create', ['tipe' => 'luar']) }}" 
                ...
                @if (!$adaPengajuan)
                    @include('user.form_mutasi_siswa.form-jenjang-' . $tipe)
                @else
