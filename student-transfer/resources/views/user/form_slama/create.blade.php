...
<div class="container mt-5">
    ...
    @php
        ...
        $layanan = $tipe === 'dalam' ? 'slama' : 'slama_luar';
        $adaPengajuan = MutasiChecker::siswaPunyaPengajuanAktif(auth()->user()->nisn, $layanan);
    @endphp

    @if ($adaPengajuan)
    <div class="alert alert-danger">
        Kamu masih punya pengajuan yang sedang diproses untuk Mutasi Keluar.
    </div>
    @endif
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="text-white">
                <h2>Mutasi Siswa Keluar</h2>
                <p>
                    Layanan ini merupakan proses pengajuan siswa yang ingin keluar dari sekolah asal (wilayah Kota Depok).
                    Pada proses ini, orang tua atau siswa akan mendapatkan Surat Rekomendasi Mutasi dari Sekolah Asal yang menyatakan bahwa siswa diizinkan pindah sekolah.
                </p>
            </div>
            <div style="border: 1px solid #0174BE; background-color: #E0F0FF; padding: 20px; border-radius: 8px;">
                ...
                <ul style="font-size: 0.925rem">
                    ...
                    <li>
                        Surat Rekomendasi Mutasi dari Sekolah yang dituju bahwa murid/siswa bisa diterima di sekolah tersebut yang ditandatangani Kepala Sekolah dan Stempel Sekolah
                    </li>
                </ul>
                <h7><strong>Catatan:</strong></h7>
                <ul style="font-size: 0.9rem">
                    <li>
                        Pengajuan 'Luar Kota' jika <u>sekolah tujuan</u> berada di <u>luar wilayah Kota Depok</u>, namun <u>sekolah asal</u> berada di <u>wilayah Kota Depok</u>.
                    </li>
                    <li>
            ...
            <div class="card shadow-lg border-0 mb-4 mt-2">
                <div class="card-header text-white" style="background-color: rgba(160, 40, 54, 0.95)">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <a href="{{ route('user.slamadetails', ['tipe' => $item->tipe == 'dalam' ? 'dalam' : 'luar', 'id' => $item->id]) }}" class="fw-bold text-dark text-decoration-none">
                                                    {{ $item->nama_sekolah ?? '-' }}
                                                </a>
                                                <div class="mt-1">
        ...
        <div class="col-md-6">
            <div class="card p-4 bg-light custom-card mb-4">
                <h3 class="text-center"  style="color: #04295a"><strong>Formulir Mutasi Keluar</strong></h3>
                <p class="text-center text-muted">Lengkapi data berikut untuk mengajukan permohonan.</p>
                <ul class="nav nav-underline custom-tabs" id="slamaTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="{{ route('user.slama.create', ['tipe' => 'dalam']) }}" 
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="{{ route('user.slama.create', ['tipe' => 'luar']) }}" 
                ...
                @if (!$adaPengajuan)
                    @include('user.form_slama.form-jenjang-' . $tipe)
                @else
