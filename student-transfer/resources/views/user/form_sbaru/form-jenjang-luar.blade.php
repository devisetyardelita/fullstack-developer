<form action="{{ route('user.sbaru-luar.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control rounded-pill @error('kelurahan') is-invalid @enderror" id="kelurahan" name="kelurahan" placeholder="Masukkan Kelurahan..." value="{{ old('kelurahan') }}" autofocus/>
        @error('kelurahan')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control rounded-pill @error('kecamatan') is-invalid @enderror" id="kecamatan" name="kecamatan" placeholder="Masukkan Kecamatan..." value="{{ old('kecamatan') }}" autofocus/>
        @error('kecamatan')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <!-- Nama Sekolah -->
    <div class="form-group mb-3">
        <label for="school_slama_name" class="fw-bold mb-1">Sekolah Asal</label>
        <input type="text" class="form-control rounded-pill @error('school_slama_name') is-invalid @enderror" id="school_slama_name" name="school_slama_name" placeholder="Masukkan Nama Sekolah Anda..." value="{{ old('school_slama_name') }}" autofocus/>
