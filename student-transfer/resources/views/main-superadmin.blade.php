      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand" style="background-color: rgba(31, 49, 111, 0.95)">
            <a href="{{ url('operator/pengaduan_langsung') }}" class="app-brand-link">
          ...
          <ul class="menu-inner py-1">
              ...
              <li class="menu-item {{ Request::is('operator/mutasi_keluar*') ? 'active' : '' }}">
                <a href="{{ url('operator/mutasi_keluar') }}" class="menu-link">
              ...
              <li class="menu-item {{ Request::is('operator/mutasi_masuk*') ? 'active' : '' }}">
                <a href="{{ url('operator/mutasi_masuk') }}" class="menu-link">
              ...
              <li class="menu-item {{ Request::is('operator/mutasi_siswa*') ? 'active' : '' }}">
                <a href="{{ url('operator/mutasi_siswa') }}" class="menu-link">
              ...
              <!-- Settings -->
              <li class="menu-item {{ Request::is('operator/akun_operator*') ? 'active' : '' }}">
                <a href="{{ url('operator/akun_operator') }}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-user"></i>
                  <div data-i18n="Settings">Akun Operator</div>
                </a>
              </li>
