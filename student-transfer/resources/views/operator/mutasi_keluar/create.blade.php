...
<div class="content">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Formulir Tambah Layanan Mutasi Siswa Keluar</h4>
        @php
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0"><i class='bx bx-chevrons-right' style="font-size: 1.5rem;"></i>Layanan Mutasi Keluar</h5>
                    </div>
                    <div class="card-body ms-3 me-5 mb-2">
                        <ul class="nav nav-underline custom-tabs" id="slamaTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('operator.slama.create', ['tipe' => 'dalam']) }}" 
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('operator.slama.create', ['tipe' => 'luar']) }}" 
                        ...
                        @if (!$adaPengajuan)
                            @include('operator.mutasi_keluar.form-jenjang-' . $tipe)
                        @else
