...
<form action="{{ route('operator.slama-luar.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row justify-content-end align-items-end">
        <div class="col-sm-10 text-end">
            ...
            <a href="{{ route('operator.slama') }}" class="btn btn-outline-secondary">Kembali</a>
        </div>
    </div>
</form>