...
<div class="content">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Detail Data Layanan Mutasi Siswa Masuk</h4>
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="divider d-flex justify-content-end align-items-end">
                        <a href="{{ url('operator/mutasi_masuk') }}" class="btn btn-outline-secondary me-4">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
