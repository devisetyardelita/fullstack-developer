...
<form action="{{ route('operator.sbaru-luar.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <!-- Sekolah Asal -->
    <div class="row mb-3">
        <label for="school_slama_name" class="col-sm-2 col-form-label">Sekolah Asal</label>
        <div class="col-sm-10">
            <input type="text" class="form-control @error('school_slama_name') is-invalid @enderror" id="school_slama_name" name="school_slama_name" placeholder="Masukkan Nama Sekolah Anda..." value="{{ old('school_slama_name') }}" autofocus/>
